...
import com.docsconsole.tutorials.controllers.ProductsControllerLogback;
...
@WebMvcTest(ProductsControllerLogback.class)
public class SpringBootCurdApplicationTests3 {
    ...
    @MockBean
    private ProductServicelogBackImpl productServiceImpl;
